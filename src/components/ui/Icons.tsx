...
/**
 * Consistent icon components for ChopChop UI
 * Using Heroicons for clean, modern appearance
 */

export const ChopIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
export const RefreshIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0V9a8 8 0 1115.356 2M15 15v4h4" />
  </svg>
);
