...
export class GitHubClient {
  ...
  async createSubtaskIssues(
    ...
    parentTitle: string,
    parentUrl?: string,
    instructions?: string, // Instructions from the execution plan
    ...
    for (let i = 0; i < subtasks.length; i++) {
      ...
      try {
        ...
        const body = this.buildIssueBody(subtask, i + 1, subtasks.length, parentTitle, parentUrl, instructions);
...
${instructionsSection}${acceptanceCriteria}${guardrails}---
